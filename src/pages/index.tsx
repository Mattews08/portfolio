...
const BoxHeader = styled.p`
  box-shadow: 0.6em 0 0 #81e6d9;
  width: 25ch;
  overflow: hidden;
  color: #fff;
  white-space: nowrap;
  animation: caret 0.5s step-end infinite alternate, type 5s steps(24, end);
  ...
  return (
    <PageLayout title="Matheus Lima - Full Stack Developer">
      <Box display="flex" justifyContent="center" borderRadius="lg" bg="teal" p={3} mb={20}>
        <BoxHeader>Hello, I&rsquo;m a Full Stack developer!</BoxHeader>
      </Box>
      <Box display={{ md: 'flex' }}>
        <Box flexGrow={1}>
          ...
          <Paragraph>
            ...
            <br />
            I'm an experienced Full-Stack Developer with skills in ReactJS, Angular, Next.js,
            TypeScript, Java, Spring Boot, SQL, Docker, Vercel, and AWS. I have knowledge in
            functional and Object-Oriented Programming (OOP), adopt practices like Test-Driven
            Development (TDD) and Clean Architecture. I work well in agile teams, using
            methodologies like Kanban and tools such as Jira and TFS. I constantly seek challenges
            and learning in a dynamic development environment.
          </Paragraph>
        </Box>
        <Box flexShrink={0} mt={{ base: 4, md: 6 }} ml={{ md: 6 }} textAlign="center">
          <Image
